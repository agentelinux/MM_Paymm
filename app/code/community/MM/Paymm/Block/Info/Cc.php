...
class MM_Paymm_Block_Info_Cc extends Mage_Payment_Block_Info
{
   /**
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        $deliveryDate = $this->getInfo()->getAdditionalInformation('deliveryDate');
        if ($deliveryDate) {

            $data[Mage::helper('paymm')->__('Delivery Date')] = $deliveryDate;
        }
